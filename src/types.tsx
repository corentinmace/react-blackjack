...
export type TexteCarte =  | "As"  | "1"  | "2"  | "3"  | "4"  | "5"  | "6"  | "7"  | "8"  | "9"  | "Valet"  | "Reine"  | "Roi";
...
export type Step =  | "null"  | "start"  | "playerturn"  | "playerended"  | "iaturn"  | "endgame"  | "win"  | "loose";
export const getDeck: () => Carte[] = () => {
  ...
  [
    ...
    ["Piques", "Carreaux", "Coeurs", "Trèfles"].forEach((enseigne: any) =>      deck.push({
        enseigne,
        valeur,
        texte,
      })
